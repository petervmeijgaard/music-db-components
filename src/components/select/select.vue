...
<script>
  ...
  export default {
     ...
     */
    components: {
      VSelectIcon: require('./select-icon'),
      VSelectItem: require('./select-item'),
      VSelectLabel: require('./select-label'),
      VSelectList: require('./select-list'),
      VSelectSelected: require('./select-selected'),
    },
  };
</script>
